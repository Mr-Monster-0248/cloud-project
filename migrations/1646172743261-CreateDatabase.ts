...
export class CreateDatabase1646172743261 implements MigrationInterface {
    name = 'CreateDatabase1646172743261'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("user_id" SERIAL NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "token" character varying NOT NULL, CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "UQ_a854e557b1b14814750c7c7b0c9" UNIQUE ("token"), CONSTRAINT "PK_758b8ce7c18b9d347461b30228d" PRIMARY KEY ("user_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "review" ("review_id" SERIAL NOT NULL, "content" character varying, "grade" integer NOT NULL, "reviewerUserId" integer, "restaurantRestaurantId" integer, CONSTRAINT "CHK_8808baf77c9283877852fa11d2" CHECK (grade BETWEEN 0 AND 5), CONSTRAINT "PK_0106a233019ba9f4ee80aca2958" PRIMARY KEY ("review_id"))`);
